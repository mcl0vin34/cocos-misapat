      ...
      _export("BoostController", BoostController = (_dec = ccclass('BoostController'), _dec2 = property(_crd && SocketManager === void 0 ? (_reportPossibleCrUseOfSocketManager({
        ...
        onBoostClicked(event) {
          if (this.socketManager) {
            var currentEnergy = this.socketManager.getCurrentEnergy();
            var currentBoosts = this.socketManager.getCurrentBoosts();
...
//# sourceMappingURL=a8c57f5c42aab0bcf3db6f37e224e2c421f1522e.js.map
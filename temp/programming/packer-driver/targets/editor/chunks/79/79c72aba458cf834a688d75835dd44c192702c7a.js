System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, UITransform, Prefab, instantiate, Vec3, sp, SocketManager, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, SpineController;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'EventTouch', 'UITransform', 'Prefab', 'instantiate', 'Vec2', 'Vec3', 'sp']);
      ...
      _export("SpineController", SpineController = (_dec = ccclass("SpineController"), _dec2 = property(sp.Skeleton), _dec3 = property(_crd && SocketManager === void 0 ? (_reportPossibleCrUseOfSocketManager({
        ...
        onSpineClicked(event) {
          ...
          if (this.socketManager) {
            const currentEnergy = this.socketManager.getCurrentEnergy(); // Проверяем, достаточно ли энергии для тапа (13 и больше)
        ...
        spawnFloatingText(tapPosition) {
          ...
          const canvasSize = canvasUITransform.contentSize; // Преобразуем позицию тапа из экранных координат в локальные координаты Canvas

          const localPosX = tapPosition.x - canvasSize.width / 2;
          const localPosY = tapPosition.y - canvasSize.height / 2;
          const localPos = new Vec3(localPosX, localPosY, 100); // Создаём экземпляр префаба
...
//# sourceMappingURL=79c72aba458cf834a688d75835dd44c192702c7a.js.map